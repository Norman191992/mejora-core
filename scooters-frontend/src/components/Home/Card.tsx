  ...
  return (
    <div className='individual-Card'>
        ...
        <Card
         ...
         style={{ width: 250 }}
         className={
            heightCard === "first" ? "firstBanner": heightCard === "second" ? "secondBanner" :  heightCard === "extra" ? "extraBanner" : "thirdBanner"
          }
         cover={
            heightCard === "extra" ? 
            <img className='imageCard' alt="example" src={image} style={{ height:  350 }} />
            :
            <img className='imageCard' alt="example" src={image}/>
        }>
            <Meta 
