...
export const FormRegister = () => {
    ...
    const onFinish = async (values: any) => {
        try {
            setLoading(true);
            const datarequest = { ...values, isCustomer: true };
            const resp = await postData('api/users/customers', datarequest)
    ...
    return (
        <Card title="Registro">
            ...
            >
                ...
                <label>Ya tienes cuenta?<a onClick={() => navigate("/login")}>Inicia Sesión</a></label>
            </Form>
        </Card>
    )
}
